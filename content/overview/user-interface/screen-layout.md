...
7. panneau [pellicule](../../module-reference/utility-modules/shared/filmstrip.md)/[chronologie](../../module-reference/utility-modules/lighttable/timeline.md) : Un panneau facultatif qui peut être activé en bas de l'écran pour afficher une chronologie (dans la vue table lumineuse) ou une pellicule (dans d'autres vues) des images de la collection actuelle.
