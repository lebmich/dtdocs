...
![présentation des mots-clés ](./tagging/tagging-overview.png#w33)
...
## modifier/renommer un mot-clé

The _tag dictionary_ can be mainained via the "edit..." and "change path..." items in the right-click pop-up menu.
