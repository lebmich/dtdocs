...
To take a snapshot, click on the _take snapshot_ button in the snapshot module. Above the button you will see a list of the various snapshots that have been taken for this editing session. The name of each snapshot reflects the most recent module name and history stack position that was active at the time the snapshot was taken.
